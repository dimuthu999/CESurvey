...
merged_data <- readRDS(file="E:/CE Survey/Data/Processed/merged_data_Nov022017.rds") # file created by 10252017_kevin_comments.R
...
stargazer(merged_data[, c("mpay_mtg","calc_mtg_pmt","non_durable","services","durable","org_year","interview_year","family_income_after_tax","family_size","age_of_ref","total_exp","total_exp_less_mtg","food_exp","all_major_outlays","entertainment_exp","vehicle_purchase_outlay","major_appliances","small_appliances","house_furnishings_and_equip","maintainance_repairs","utility_exp")], type = output.type, summary.stat = c("mean", "sd", "p25", "median", "p75", "n"),notes = "",digits = 4)
```
...
for(dep_var in dep_vars) {
  cat(paste("\n\n\n*******************",dep_var,"*********************\n\n\nSummary Statistics\n"))
  reg_data <- merged_data[is.finite(log(merged_data$family_income_after_tax)),]
